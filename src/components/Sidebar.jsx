...
export function Sidebar() {
    ...
    return (
        <header className=" w-[320px] h-14 md:h-full min-w-[320px] border-r-[1px] border-[#ccc] p-6 flex  md:flex-col  gap-5">
            <Link to="/" className="text-2xl text-[#263238] flex items-center">
                <img src="/logo.jpg" alt="" className="w-14" />
                <span >Brand</span>
                <strong >Colors</strong>
            </Link>
            <div className="h-full w-full md:flex flex-col gap-4 hidden ">
